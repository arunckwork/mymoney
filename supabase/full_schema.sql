...
create policy "Users can delete own accounts"
  on public.user_accounts for delete using (auth.uid() = user_id);

create policy "Users can view own categories"
  on public.user_income_expense_categories for select using (auth.uid() = user_id);
create policy "Users can insert own categories"
  on public.user_income_expense_categories for insert with check (auth.uid() = user_id);
create policy "Users can update own categories"
  on public.user_income_expense_categories for update
  using (auth.uid() = user_id) with check (auth.uid() = user_id);
create policy "Users can delete own categories"
  on public.user_income_expense_categories for delete using (auth.uid() = user_id);

create policy "Users can view own expenses"
  on public.user_expenses for select using (auth.uid() = user_id);
create policy "Users can insert own expenses"
  on public.user_expenses for insert with check (auth.uid() = user_id);
create policy "Users can update own expenses"
  on public.user_expenses for update
  using (auth.uid() = user_id) with check (auth.uid() = user_id);
create policy "Users can delete own expenses"
  on public.user_expenses for delete using (auth.uid() = user_id);

create policy "Users can view own incomes"
  on public.user_incomes for select using (auth.uid() = user_id);
create policy "Users can insert own incomes"
  on public.user_incomes for insert with check (auth.uid() = user_id);
create policy "Users can update own incomes"
  on public.user_incomes for update
  using (auth.uid() = user_id) with check (auth.uid() = user_id);
create policy "Users can delete own incomes"
  on public.user_incomes for delete using (auth.uid() = user_id);
